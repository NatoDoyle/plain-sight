...
Two distinct forces, usually entangled [1]: **informational influence** — others' behavior is genuine data about reality, especially when you're uncertain and they seem similar or expert; and **normative influence** — visible deviation costs approval, so people conform outwardly even while privately disagreeing. Social proof binds hardest under **uncertainty**, **similarity** (people "like me"), and **numbers/unanimity**. It is amplified in collectivist cultural contexts [3] and operates beneath awareness — people reliably deny being influenced by it while being influenced by it.
...
- **Fraud networks** — Ponzi schemes run on visible early payouts and respected-investor rosters; [[affinity-fraud]] adds "people exactly like me" (Madoff's country-club and community networks); "everyone in the congregation is in" is the highest-octane social proof there is ([[ponzi-psychology]]).
- **Staged scarcity of dissent** — screened audiences, deleted negative comments, NDA'd ex-members: the crowd looks unanimous because disagreement was removed ([[cults-high-control]], [[smear-campaigns]] against defectors).
- **Compliance scripts** — fraud callers and pressure sellers deploy "most people in your situation do X" precisely because norm-citation moves behavior [6].

## Ethical use vs exploitation

Citing *real* norms honestly (towel reuse, tax compliance, vaccination rates) is legitimate persuasion — and often helpful. The line ([[manipulation-vs-influence]]): exploitation **fabricates the crowd, curates away dissent, or cites consensus that cannot be audited**. A true number you can check is information; an unverifiable "everyone" is a lever.
...
1. **Audit the crowd** ([[verification-rituals]]): Who exactly? Do they exist? Are they like me? Are they paid, staged, or filtered? Can the number be checked from an independent source?
2. **Deliberately sample dissent**: read the 1-star reviews first; seek ex-members, ex-employees, ex-investors ([[cult-exit-support]] exists because exits are hidden). If dissent is suspiciously absent, treat that as data.
3. **The solo test**: "Would I do this if no one else were doing it?" — separates the merits from the herd.
4. **One ally suffices**: conformity pressure collapses with a single fellow dissenter [2] — find or be that person ([[helping-others]]).
5. **Base-rate the domain** ([[epistemic-guardrails]]): in domains where you hold real information, weight it; in domains of true uncertainty, crowds help — *if* they're real and independent (see Caveats).
...
1. Deutsch, M., & Gerard, H. (1955). "A study of normative and informational social influences upon individual judgment." *Journal of Abnormal and Social Psychology* 51(3), 629–636.
2. Asch, S. (1956). "Studies of independence and conformity." *Psychological Monographs* 70(9); Asch (1951) in Guetzkow (ed.), *Groups, Leadership and Men.*
3. Bond, R., & Smith, P. (1996). "Culture and Conformity: A Meta-Analysis of Studies Using Asch's Line Judgment Task." *Psychological Bulletin* 119(1), 111–137.
...
11. FTC, Trade Regulation Rule on the Use of Consumer Reviews and Testimonials, 16 CFR Part 465 (final rule announced Aug 2024; effective Oct 21, 2024). https://www.ftc.gov/news-events/news/press-releases/2024/08/federal-trade-commission-announces-final-rule-banning-fake-reviews-testimonials
12. Mathur, A., et al. (2019). "Dark Patterns at Scale." *Proc. ACM HCI* 3(CSCW), art. 81.
13. Bikhchandani, S., Hirshleifer, D., & Welch, I. (1992). "A Theory of Fads, Fashion, Custom, and Cultural Change as Informational Cascades." *Journal of Political Economy* 100(5), 992–1026.

## See also

[[fake-reviews-astroturfing]] · [[dark-patterns-social-urgency]] · [[affinity-fraud]] · [[ponzi-psychology]] · [[disinformation-playbooks]] · [[propaganda-devices]] · [[unity-ingroup]] · [[verification-rituals]]
