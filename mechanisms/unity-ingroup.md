...
> The deepest influence lever isn't being liked — it's being *one of us*. When identity fuses ("we"), persuasion stops being something done *to* you and becomes something you do *for* your people. Manufacture the "we", and defenses don't just lower; they defect to the other side.

## The lever

Humans favor in-group members automatically and on astonishingly thin grounds: in the **minimal group paradigm**, being told you're a "Klee person" rather than a "Kandinsky person" — an arbitrary, trivial label — was enough to produce favoritism in allocating real rewards [1]. **Social identity theory** explains why: group memberships are part of the *self*, so the group's wins and threats are processed as your own, and salient membership shifts cognition from "I" to "we" [2]. Cialdini elevated **unity** to a distinct principle: the "we"-relationships of kinship, place, and tribe, *plus acting together* — synchrony, co-creation, shared ritual — which manufactures we-ness behaviorally (synchronous movement alone measurably increases subsequent cooperation, even at personal cost) [3][4]. Meta-analytically, in-group favoritism in cooperation is robust though modest (d ≈ 0.32) and reflects **in-group love far more than out-group hate** [5].

## Evidence base

- Minimal groups: arbitrary categorization → reward favoritism, absent self-interest or prior hostility [1].
- Identity → influence: people weight in-group sources more, conform to in-group norms, and sacrifice for group goals [2][5].
- Acting together: synchronous marching/singing/moving raised cooperation in economic games across three experiments [4].
- Kinship leverage: Cialdini's classroom demonstration — tying a parent questionnaire to their *child's* extra credit raised response from under 20% to 97% [3]. (An illustration he reports, not a controlled-literature effect size.)
- Field confirmation at fraud scale: **affinity fraud** — the SEC's standing category for investment scams that prey on identifiable groups (religious, ethnic, elderly, professional), where fraudsters are or pose as members and recruit respected community leaders as unwitting endorsers. Madoff is the flagship: an "affinity Ponzi" run through Jewish communities, charities, and institutions [6].

## How it's weaponized

The recurring exploit: **a manufactured or borrowed "we", invoked at the moment of the ask.**

- **Forced teaming** — de Becker's pre-incident indicator: a stranger projecting shared purpose or predicament where none exists ("we're in the same boat", "how are *we* going to handle this?"). It manufactures premature trust that feels rude to rebuff — *that rudeness-cost is the design* [7].
- **Affinity fraud** — "one of us" as the master key: same church, same regiment, same homeland. Endorsement cascades through the community's trust network, and victims under-report out of in-group shame [6] ([[affinity-fraud]], [[ponzi-psychology]]).
- **Instant family** — cults and high-control groups deploy fictive kinship ("brothers and sisters", the leader as Father/Mother) and the "offer of instant companionship" Singer flagged as a deceptive recruiting ploy ([[love-bombing]] in group form, [[cult-conversion-funnel]]); belonging is delivered first, the bill arrives later [8].
- **Synchrony engineering** — chanting, group song, drilling, corporate chants, mass calisthenics, call-and-response rallies: acting-together as bonding technology [4] — benign in choirs, load-bearing in high-control groups and rallies ([[cults-high-control]], [[propaganda-politics]]).
- **"We're a family" employers** — kin-language imported to extract unpaid loyalty and suppress complaint ([[we-are-family-rhetoric]], [[workplace-bosses]]).
- **Us-vs-them escalation** — identity hardened by a contaminating out-group; the radicalization funnel's fuel ([[radicalization-pipeline]], [[disinformation-playbooks]]; the propaganda devices "plain folks" and "transfer" are unity moves [[propaganda-devices]]).
- **Brand and scene tribes** — engineered identity consumption (fan armies, platform tribalism): mostly commerce, but the same lever ([[parasocial-influencer-tactics]], [[advertising-marketing]]).

## Ethical use vs exploitation

Belonging is a fundamental human need, and real communities — families, congregations, unions, regiments, fandoms — are the very good this lever exists to serve. The line ([[manipulation-vs-influence]]): exploitation shows a **manufactured we** (no actual shared fate), **identity invoked precisely at extraction points** ("as one of us, you'll want to invest"), and **exit priced as betrayal**. Real community survives your "no" and your leaving; weaponized unity treats both as treason.
...
[[affinity-fraud]] · [[love-bombing]] · [[cult-conversion-funnel]] · [[we-are-family-rhetoric]] · [[radicalization-pipeline]] · [[social-proof]] · [[liking-similarity]] · [[isolation-tactics]]
